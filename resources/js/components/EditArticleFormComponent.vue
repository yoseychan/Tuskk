                ...
                <div class="">
                    <div class="">
                        <form enctype="multipart/form-data" class="article-form">
                            ...
                            <div>
                                <button v-if="user.id == form.user_id" @click="submitForm(form.id)" type="button" class="submitArticle">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            submitForm($id) {
                    axios.put('/api/articles/' + $id, this.form)
                        .then((response) => {
        ...
        mounted() {
            this.form = JSON.parse(this.dataArticle);
